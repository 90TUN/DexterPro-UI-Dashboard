      ...
      >
        {selectedOrder && (
          <div>
            ...
            <p>
              <strong>Name:</strong> {selectedOrder.user.first_name}{" "}
              {selectedOrder.user.last_name}
            </p>
            <br />
            <h3>Shop</h3>
            <p>
              <strong>ID:</strong> {selectedOrder.shop.id}
            </p>
            <p>
              <strong>Name:</strong> {selectedOrder.shop.name}
            </p>
            <br />
            <h3>Order Details</h3>
            <p>
            ...
            <p>
              <strong>Subtotal Amount:</strong> {selectedOrder.subtotal_amount}
            </p>
            <p>
              <strong>Discount Amount:</strong> {selectedOrder.discount_amount}
            </p>
            <p>
              <strong>Tax Amount:</strong> {selectedOrder.tax_amount}
            </p>
            <p>
              <strong>Total Amount:</strong> {selectedOrder.total_amount}
            </p>
            <p>
              <strong>Shipping Cost:</strong> {selectedOrder.shipping_cost}
            </p>
            <p>
            ...
            <p>
              <strong>Fulfilled At:</strong> {selectedOrder.fulfilled_at}
            </p>
            <p>
              <strong>Created At:</strong> {selectedOrder.created_at}
            </p>
            <p>
              <strong>Updated At:</strong> {selectedOrder.updated_at}
            </p>
            <p>
              <strong>Deleted At:</strong> {selectedOrder.deleted_at}
            </p>
